...
def send_email(conf):
    fromaddr = "galmoore14@gmail.com" 
    for email_address in conf['email_address']:
        toaddrs  = "galmoore14@gmail.com"
        print("[INFO] Emailing to {}".format(email_address))
        text = 'What is he up too??? Naughty shmoops!!!!'
        subject = 'Shmoop Identified!!! Security Breach!!'
        message = 'Subject: {}\n\n{}'.format(subject, text)
